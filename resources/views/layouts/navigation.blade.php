<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky-top shadow-sm">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div x-data="{{ json_encode(['name' => optional(auth()->user())->name]) }}" x-text="name">
                            </div>
            ...
            <!-- Hamburger -->
            <div class="flex sm:hidden items-center -me-2">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="px-4">
                <div class="font-medium text-base text-gray-800"
                    x-data="{{ json_encode(['name' => optional(auth()->user())->name]) }}" x-text="name"></div>
